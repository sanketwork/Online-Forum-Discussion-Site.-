...
<form action="code/logincode.jsp" method="post">
    ...
    <div id="header"  style="background-image:url('images/back.jpg'); background-repeat:no-repeat;background-size: cover; "></div>            
     ...
     <li><a href="enquiry.jsp">ENQUIRY</a></li>
                    ...
                    <div id="main" style="background-image:url('images/forum.jpg'); background-repeat:no-repeat;background-size: cover;">
	...
	<br/>
	 ...
	 <center> <h3>Developed By: Sanket Jagtap</h3>
	  <p style="line-height:25px; text-align:center; ">To contact us email me at <a href="">sanketswork7@gmail.com</a><br/>
	  <a href="http//www.google.co.in">Help</a><br/><br/>
